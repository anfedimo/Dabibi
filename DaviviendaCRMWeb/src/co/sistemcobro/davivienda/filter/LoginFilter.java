package co.sistemcobro.davivienda.filter;
...
import co.sistemcobro.davivienda.bean.ClienteBean;
import co.sistemcobro.davivienda.bean.UsuarioHermes;
import co.sistemcobro.davivienda.session.LoginBean;
import co.sistemcobro.davivienda.constante.Constante;
...
public class LoginFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
		...
		if (loginBean != null && StringUtils.isNoneBlank(loginBean.getUsuario())
			...
			logger.info("La sesion en SistemCartera a expirado..");
